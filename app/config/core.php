 ...
 */
	Configure::write('Security.salt', '033263cc4565fb37a241212240ba27693398efd2');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '636539306465323863346539653366');
...
/*Cache::config('default', array(
 		...
 		'duration'=> 3600, //[optional]
 		'probability'=> 100, //[optional]
  		'prefix' => Inflector::slug(APP_DIR) . '_main_', //[optional]  prefix every cache file with this string
 	));*/
