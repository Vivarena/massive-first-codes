...
class SwiftMailerComponent extends Object {
     ...
     * @access Public 
     */
    var $smtpUsername = 'vivarena.site@gmail.com';
//    var $smtpUsername = 'mail@vivarena.project-release.info';
     ...
     * @access Public 
     */      
    var $smtpPassword = 'vivaQaz987';
//    var $smtpPassword = 'qwe123';
    /**
...
//    var $smtpHost = 'mail.vivarena.project-release.info';
    /**
...
//    var $smtpPort = 25;
     ...
     * @access Public 
     */      
    var $from = "no_reply@vivarena.com";
    /** 
     * Email from name 
     *  
     * @var String 
     ...
     * @access Public 
     */ 
    var $replyTo = "no_reply@vivarena.com";
    /** 
