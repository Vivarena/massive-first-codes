...
namespace MegaHook\Interceptor;
...
class Interceptor {
    ...
    public function __call($method, $args) {
        ...
        if (method_exists($this, "before")) $this->before($this->_rootObject, $method, $args);
        ...
        if (method_exists($this, "after")) $this->after($this->_rootObject, $method, $args);
