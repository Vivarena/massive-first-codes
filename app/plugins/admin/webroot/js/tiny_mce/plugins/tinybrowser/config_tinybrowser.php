...
$tinybrowser['obfuscate'] = 's0meolmDSIE9Co#m3baseS1om0';
...
$tinybrowser['docroot'] = rtrim($_SERVER['DOCUMENT_ROOT'], DS) . DS . 'app' . DS . 'webroot';

// Folder permissions for Unix servers only
$tinybrowser['unixpermissions'] = 0755;

$uploadDirPath = DS . 'uploads' . DS;
// File upload paths (set to absolute by default)
$tinybrowser['path']['image'] = $uploadDirPath . 'images' . DS; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $uploadDirPath . 'media' . DS; // Media files location
$tinybrowser['path']['file']  = $uploadDirPath . 'files' . DS; // Other files location
