...
function ratingInitForForm(element, data, config, options, enabled) {
    ...
    ratingFormSet = ratingSettings[element]['options']['rating_init'];
    ratingSettings[element]['data']['%RATING%'] = ratingSettings[element]['options']['rating_init'];
    ratingSettings[element]['data']['%AVG%'] = ratingSettings[element]['options']['rating_init'];
    ratingReset(element);
}
...
function ratingResetForm(element) {
    if (ratingSettings[element]['config']['showUserRatingStars']) {
        ratingSet(element, ratingFormSet);
    } else {
        ratingSet(element, ratingFormSet);
    }
