...
//                        updateCart(response);
            ...
            function setDiscount() {
                ...
                $.get("/products/add_discount/" + value,
                    function(data){
                        if(data)
                        {
                            if (flag) {
           ...
           function updateCart(cartData)
           {
               ...
               $.each(cartData.Products, function(key, product){
                   ...
                   $('#product-qty-' + id).find('input').val(product.qty);
    ...
    function setShipping(value, type)
    {
        ...
        jQuery.get("/products/set_shipping/" + value + "/" + type,
            function(data) {
